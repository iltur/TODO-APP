...
@NgModule({
	...
	declarations: [],
	providers: [FirebaseAddtaskService, { provide: ADDS_ADDTASK_DTO, useExisting: FirebaseAddtaskService }, { provide: GETS_ALL_ADDTASK_DTO, useExisting: FirebaseAddtaskService }, { provide: SETS_ADDTASK_DTO, useExisting: FirebaseAddtaskService }],
	exports: []
})
